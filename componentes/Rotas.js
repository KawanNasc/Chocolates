  ...
  return (
    ...
    <ScrollView>
      ...
      <SafeAreaView style={estilos.tela}>
        ...
        <Image style={estilos.img} source={require("../assets/imgs/aoleite.png")} />

        <Text style={estilos.chocolates}>Amargo</Text>
        <Image style={estilos.img} source={require("../assets/imgs/amargo.png")} />

        <Text style={estilos.chocolates}>De Soja</Text>
        <Image style={estilos.img} source={require("../assets/imgs/desoja.png")} />
